...
static void stream_splitter(StreamT &in, StreamT outs0[kPackets],
                            StreamT outs1[kPackets], StreamT outs2[kPackets],
                            const int cols, const int rep_rows) {
#pragma HLS INLINE off
...
#pragma HLS INTERFACE s_axilite register port = return
  ...
  static StreamT stream_a[3][kPackets];
#pragma HLS ARRAY_PARTITION dim = 0 type = complete variable = stream_a
  static StreamT stream_b[3][kPackets];
#pragma HLS ARRAY_PARTITION dim = 0 type = complete variable = stream_b
  ...
  static StreamSingleT stream_out[3][kPackets];
