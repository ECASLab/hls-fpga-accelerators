...
open_project cascade
set_top cascade
# v++ -g, -D, -I, --advanced.prop kernel.cascade.kernel_flags
add_files "./cascade.cpp" -cflags " -DUSE_$datatype -DBUS=$bus -DA_ROWS=$a_rows -DB_COLS=$b_cols -DC_COLS=$c_cols "
...
config_export -format xo -ipname cascade
csynth_design
close_project
