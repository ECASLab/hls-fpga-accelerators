...
open_project matvecmul
set_top matvecmul
# v++ -g, -D, -I, --advanced.prop kernel.matvecmul.kernel_flags
add_files "./matvecmul.cpp" -cflags " -DUSE_$datatype -DBUS=$bus -DA_ROWS=$a_rows -DB_COLS=$b_cols -DC_COLS=$c_cols "
...
config_export -format xo -ipname matvecmul
csynth_design
close_project
