...
open_project softmax_taylor
set_top softmax_taylor
# v++ -g, -D, -I, --advanced.prop kernel.softmax_taylor.kernel_flags
add_files "./softmax_taylor.cpp" -cflags " -I /home/anthony/repositories/softmax_taylor/ -DUSE_$datatype -DBUS=$bus -DM_COLS=$cols -DM_ROWS=$rows "
add_files -tb "./softmax_taylor_tb.cc" -cflags " -I /home/anthony/repositories/softmax_taylor/ -DUSE_$datatype -DBUS=$bus -DM_COLS=$cols -DM_ROWS=$rows "
